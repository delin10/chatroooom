package nil.ed.chatroom.util.sensitive;

import nil.ed.chatroom.util.sensitive.matcher.MatchResult;
import nil.ed.chatroom.util.sensitive.matcher.MatchText;
import nil.ed.chatroom.util.sensitive.matcher.StringMatchText;
import nil.ed.chatroom.util.sensitive.matcher.TextMatcher;
import nil.ed.chatroom.util.sensitive.util.Arrayx;
